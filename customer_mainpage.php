...
<body style="background-image:url(AstraBank_Victoria/assets/images/pic1.png);">
    ...
    <table width="80%" border="1" cellspacing="5" cellpadding="5" align="center">
        <tr>
            <th colspan="4" style="text-align: center;">Customer Main Page</th>
        </tr>
        <tr>
            <td><a href="customer_account_details.php">Account Details</a></td>
        </tr>
        <tr>
            <td><a href="cutomer_balance.php">Check Balance</a></td>
        </tr>
        <tr>
            <td><a href="cutomer_transfer.php">Transfer Money</a></td>
        </tr>
        <tr>
            <td><a href="customer_transactions_list.php">Transaction List (History)</a></td>
        </tr>
        <tr>
