...
<body style="background-image:url(AstraBank_Victoria/assets/images/pic1.png);">
    ...
    <div class="content">
        <table align="center" border="1" width="80%" cellpadding="5" cellspacing="5" style="margin-bottom: 20px;margin-top: 20px;">
            <tr>
                <th colspan="8" style="text-align: center;">Customer Transactions List (History)</th>
            </tr>
            <tr>
                ...
                <th style="text-align: center; background-color: rgba(0, 0, 0, 0.2); color: #333; font-weight: lighter; font-size: 16px; height: 30px; padding: 8px;">Available Balance Amount</th>
                <th style="text-align: center; background: #fff; color: #333; font-weight: lighter; font-size: 16px; height: 30px; padding: 8px;">Details</th>
            </tr>
            <?php
