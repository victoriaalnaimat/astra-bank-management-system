...
<head>
  ...
  <style>
    ...
    *:after {
    ...
    .shape:first-child {
    background: linear-gradient(to right, #40826D, #ECFFDC); /* Change the gradient colors here */
    left: -80px;
    top: -80px;
  }

  .shape:last-child {
    background: linear-gradient(to left, #008080, #ECFFDC); /* Change the gradient colors here */
    right: -30px;
    bottom: -80px;
  }
  </style>
  ...
  <main style="margin-bottom: -5vh;">
    ...
    <div class="login-container">
      <form name="form1" method="post" action="admin_login.php">
        ...
        <input type="text" name="text1" id="text1" placeholder="Enter your UserID here....">

        <label for="text2">Password</label>
        <input type="password" name="text2" id="text2" placeholder="Enter your password here...."><br/>

        <div class="form-group">
          <input type="submit" name="Login" value="Login"><br/>
          <a href="mainpage.php" style="background-color: rgba(255, 255, 255, 0.6);padding: 1vh;border-radius: 5px;box-shadow: 0 0 21.5px rgba(0, 0, 0, 0.2);text-decoration: none;color: black;font-weight: bolder;text-align: center;display: block;
  width: 100%;">Back</a>
        </div>
      </form>
    </div>
